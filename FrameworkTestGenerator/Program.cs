...
namespace TestGenerator
{
    public class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            string testClassNamespace = directories[directories.Length - 4] 
                + "." + directories[directories.Length - 3] 
                + "." + directories[directories.Length - 2];
            string setupNamespace = directories[directories.Length - 4] 
                + "." + directories[directories.Length - 3] + "." + "Setup";
            ...
            var types = testController.LoadTypes(fileInfo)
                .Where(t=>t.Name.EndsWith("Controller")).ToList();
